...
public class Player {
  ...
  public Boolean isBoardFilled() { return playerTableau.isBoardFilled(); }
  String takeTurn() {
    String actionChosen = "";
  ...
  void abilityParser(
      AbilityPair ability) // temporary location for the ability parser function
  {
    int num = 0;
    String number;
    ...
    for (String word : ability_split) {
      ...
      if (word.contains("+") || word.contains("-")) {
        ...
        soil += num;
        gainedSoil += num;
        // Soil gained need to be reset somewhere putting at the end of the turn
        // for now
   ...
   */
  public ArrayList<Card> getCompostPile() { return compostPile; }

  /**
   * @return the gainedSoil
   */
  public int getGainedSoil() { return gainedSoil; }

  /**
   * @return the eventStack
   */
  public ArrayList<Card> getEventStack() { return eventStack; }
   ...
   */
  public int getGainedCards() { return gainedCards; }

  /**
   * @return the m_climateCard
   */
  public Card getM_climateCard() { return m_climateCard; }

  /**
   * @return the m_islandCard
   */
  public Card getM_islandCard() { return m_islandCard; }

  /**
   * @return the playerTabulue
   */
  public Tableau getPlayerTableau() { return playerTableau; }
  ...
  public void discard(int numberToDiscard) {
    for (int i = 0; i < numberToDiscard; i++) {
      if (hand.size() == 0) {
        return;
      } // No discard possible, should never reach this from
