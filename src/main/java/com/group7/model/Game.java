...
public class Game {
  ...
  public Game(int numberOfPlayers) {
    ...
    mainTurnLoop(
        iter); // Take a regular turn, and being the checks for complete Island
  }
  ...
  public Game(Controller controller, int numberOfPlayers) {
    ...
    // takeTurnZero(); // Island and Climate Setup
    mainTurnLoop(
        iters); // Take a regular turn, and being the checks for complete Island
  }
  ...
  String getActionChoice() { return m_control.getActionChoice(); }

  public ArrayList<Card> getFuanaCards() { return FuanaCards; }
   ...
   */
  public Deck getClimateDeck() { return ClimateDeck; }

  /**
   * @return the earthDeck
   */
  public Deck getEarthDeck() { return EarthDeck; }

  /**
   * @return the fuanaDeck
   */
  public Deck getFuanaDeck() { return FuanaDeck; }

  /**
   * @return the islandDeck
   */
  public Deck getIslandDeck() { return IslandDeck; }
   ...
   */
  public int getM_numberOfPlayers() { return m_numberOfPlayers; }
