...
public class Deck {
  ...
  Deck() {
    deckList = new ArrayList<Card>(); /* Suppose to start by building a deck
                                         from a given file */
  }
   ...
   * @return the deckList
   */
  public ArrayList<Card> getDeckList() { return deckList; }
  ...
  void fillEarthDeck() throws FileNotFoundException {
    ...
    try {
      file = new File(
          "src/main/java/com/group7/Model/Cards/decklists/terrain_cards.csv");
  ...
  void fillClimateDeck() {
    ...
    try {
      file = new File(
          "src/main/java/com/group7/Model/Cards/decklists/climate_cards.csv");
      deck_file = new Scanner(file);
      deck_file.nextLine();
      deck_file.nextLine();
      deck_file.nextLine();
  ...
  void fillFuanaDeck() {
    ...
    try {
      file = new File(
          "src/main/java/com/group7/Model/Cards/decklists/fuana_cards.csv");
      deck_file = new Scanner(file);
      deck_file.nextLine();
      deck_file.nextLine();
      deck_file.nextLine();
  ...
  void fillIslandDeck() {
    ...
    try {
      file = new File(
          "src/main/java/com/group7/Model/Cards/decklists/island_cards.csv");
      deck_file = new Scanner(file);
      deck_file.nextLine();
      deck_file.nextLine();
      deck_file.nextLine();
